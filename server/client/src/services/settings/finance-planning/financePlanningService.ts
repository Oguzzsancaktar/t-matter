...
import { ICustomer, IFinancePlanning, Invoice, IQueryParams } from '@/models'
...
type IBuilder = EndpointBuilder<
  IAxiosBaseQueryFn,
  typeof FINANCE_PLANNING_TAG_TYPE | typeof INVOICE_CATEGORY_TAG_TYPE | typeof INVOICE_TAG_TYPE,
...
const financePlanningApi = createApi({
  ...
  tagTypes: [FINANCE_PLANNING_TAG_TYPE, INVOICE_CATEGORY_TAG_TYPE, INVOICE_TAG_TYPE],
