...
import { ICompanyPricingPatchDTO, ICompanyPricing } from '@/models'
...
const { useGetCompanyPricingQuery, usePatchCompanyPricingMutation } = companyPricingApi
export { companyPricingApi, useGetCompanyPricingQuery, usePatchCompanyPricingMutation }
